...
subtitle: "A Glimpse into the Organizing Journey of DUHacks 3.0"
bannerUrl: "/duhacks/duhacks.jpeg"
---
...
<Image
  className="rounded-md"
  src="/duhacks/duhacks-session.jpeg"
  alt="duhacks"
  width={600}
  height={200}
/>
The second day of DUHacks 3.0 dawned with renewed energy and enthusiasm. The day
kicked off with informative sessions designed to inspire and guide participants in
their hackathon projects. I was one of the speakers, sharing some knowledge and insights
on good developement.

<Image
  className="rounded-md"
  src="/duhacks/duhacks5.jpeg"
  alt="duhacks"
  width={500}
  height={200}
/>
